...
//	face is a keyword understood as interface.
//	implicit breaks inserted by the compiler must be OCBREAK
//	c <- v is a valid expression of type bool, as is ok := c <- v
...
//
// At top-level, struct N { ... } and interface N {...} are shorthands for
//	type N struct { ... } and type N interface {...}
// [nemo]
...
// 	FallthroughStmt | Block | IfStmt | SwitchStmt | SelectStmt | ForStmt | DoSelectStmt |
// 	DeferStmt .
//
